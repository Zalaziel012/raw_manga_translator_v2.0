...
Instructions:
Enter raw_manga_translator: cd raw_manga_translator
...
Istruzioni:
Entra in raw_manga_translator: cd raw_manga_translator
Installa le dipendenze: pip install -r requirements.txt
Doppio clik su run_pipeline.bat o (nel cmd) python run_all_pipeline.py
